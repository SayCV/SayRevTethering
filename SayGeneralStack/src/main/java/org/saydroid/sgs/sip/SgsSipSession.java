 ...
 */
public abstract class SgsSipSession extends SgsObservableObject implements Comparable<SgsSipSession>{
	private static final String TAG = SgsSipSession.class.getCanonicalName();
	
	protected SgsSipStack mSipStack;
     ...
     */
    protected SgsSipSession(SgsSipStack sipStack){
        mSipStack = sipStack;
        mOutgoing = false;
	...
	@Override
	public int compareTo(SgsSipSession arg0) {
