...
import org.saydroid.sgs.events.SgsMediaPluginEventArgs;
import org.saydroid.sgs.events.SgsMediaPluginEventTypes;
...
public class SgsProxyVideoConsumer extends SgsProxyPlugin{
	private static final String TAG = SgsProxyVideoConsumer.class.getCanonicalName();
    ...
    public SgsProxyVideoConsumer(BigInteger id, ProxyVideoConsumer consumer){
    	super(id, consumer);
    	mConsumer = consumer;
    	...
    	mWidth = SgsProxyVideoConsumer.DEFAULT_VIDEO_WIDTH;
    	mHeight = SgsProxyVideoConsumer.DEFAULT_VIDEO_HEIGHT;
    	mFps = SgsProxyVideoConsumer.DEFAULT_VIDEO_FPS;
    }
    ...
    private int prepareCallback(int width, int height, int fps){
		...
		mFullScreenRequired = SgsEngine.getInstance().getConfigurationService().getBoolean(
				SgsConfigurationEntry.GENERAL_FULL_SCREEN_VIDEO, 
				SgsConfigurationEntry.DEFAULT_GENERAL_FULL_SCREEN_VIDEO);
    ...
    private int startCallback(){
    	Log.d(SgsProxyVideoConsumer.TAG, "startCallback");
    	super.mStarted = true;
    	return 0;
    }
    ...
    {
        final SgsProxyVideoConsumer myConsumer;

        public MyProxyVideoConsumerCallback(SgsProxyVideoConsumer consumer){
        	super();
            myConsumer = consumer;
        }
        ...
        public int prepare(int width, int height, int fps){
            ...
            SgsMediaPluginEventArgs.broadcastEvent(new SgsMediaPluginEventArgs(myConsumer.mId, SgsMediaType.Video, 
            		ret == 0 ? SgsMediaPluginEventTypes.PREPARED_OK : SgsMediaPluginEventTypes.PREPARED_NOK));
            return ret;
        }
        ...
        public int start(){
            ...
            SgsMediaPluginEventArgs.broadcastEvent(new SgsMediaPluginEventArgs(myConsumer.mId, SgsMediaType.Video, 
            		ret == 0 ? SgsMediaPluginEventTypes.STARTED_OK : SgsMediaPluginEventTypes.STARTED_NOK));
            return ret;
        }
        ...
        public int pause(){
            ...
            SgsMediaPluginEventArgs.broadcastEvent(new SgsMediaPluginEventArgs(myConsumer.mId, SgsMediaType.Video, 
            		ret == 0 ? SgsMediaPluginEventTypes.PAUSED_OK : SgsMediaPluginEventTypes.PAUSED_NOK));
            return ret;
        }
        ...
        public int stop(){
            ...
            SgsMediaPluginEventArgs.broadcastEvent(new SgsMediaPluginEventArgs(myConsumer.mId, SgsMediaType.Video, 
            		ret == 0 ? SgsMediaPluginEventTypes.STOPPED_OK : SgsMediaPluginEventTypes.STOPPED_NOK));
            return ret;
        }
    }
