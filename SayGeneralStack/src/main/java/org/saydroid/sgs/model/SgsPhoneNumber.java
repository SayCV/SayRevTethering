...
public class SgsPhoneNumber {	
	...
	public SgsPhoneNumber(PhoneType type, String number, String description){
		mType = type;
		mNumber = number;
	 ...
	 */
	public static class PhoneNumberFilterByType implements SgsPredicate<SgsPhoneNumber>{
		private final PhoneType mType;
		PhoneNumberFilterByType(PhoneType type){
			mType = type;
		}
		@Override
		public boolean apply(SgsPhoneNumber phoneNumber) {
	 ...
	 */
	public static class PhoneNumberFilterByAnyValid implements SgsPredicate<SgsPhoneNumber>{
		PhoneNumberFilterByAnyValid(){
		}
		@Override
		public boolean apply(SgsPhoneNumber phoneNumber) {
			return (phoneNumber != null && !SgsStringUtils.isNullOrEmpty(phoneNumber.getNumber()));
		}
	}
}
