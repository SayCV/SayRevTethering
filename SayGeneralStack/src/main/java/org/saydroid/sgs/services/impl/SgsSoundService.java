...
/**@page SgsSoundService_page Sound Service
 * 
 ...
 * SgsEngine mEngine = SgsEngine.getInstance();
 ...
 * Sound service.
 */
public class SgsSoundService extends SgsBaseService implements ISgsSoundService{
	private final static String TAG = SgsSoundService.class.getCanonicalName();
	...
	public void startRingTone() {
		if(mRingtonePlayer == null){
			try{
				mRingtonePlayer = RingtoneManager.getRingtone(SgsApplication.getContext(), android.provider.Settings.System.DEFAULT_RINGTONE_URI);
			}catch(Exception e){
				e.printStackTrace();
				return;
			}
